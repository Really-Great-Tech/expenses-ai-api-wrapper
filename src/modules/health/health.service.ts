...
export class HealthService {
  ...
  private getEnvironmentVariables() {
    return {
      ...
      AWS_ACCESS_KEY_ID: this.maskApiKey(this.configService.get('AWS_ACCESS_KEY_ID')),
      AWS_SECRET_ACCESS_KEY: this.maskApiKey(this.configService.get('AWS_SECRET_ACCESS_KEY')),
      AWS_REGION: this.configService.get('AWS_REGION', 'not set'),
